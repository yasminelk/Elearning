...
<%
    ...
    if (request.getAttribute("time") != null) {
        time = ((Date) request.getAttribute("time")).getTime();
    }
%>
<!DOCTYPE html>
<html>
                        ...
                        <form class="form-horizontal" action="examanswer" method="POST">
                            <div class="header">
                                <div class="form-group">
                                    <div class="col-sm-10">
                                        <h3>
                                            Exam (<%=((Exam) request.getAttribute("exam")).getTotalPoints()%> Pts)
                                        </h3>
                                    </div>
                                    <div class="col-sm-2">
                                        <h3 id="timer"/>
                            ...
                            <div class="body">
                                ...
                                <div class="question_row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="<%=q.getId()%>" type="radio" value="<%=subQuestions.get(i - 1).get(0).getId()%>" id="radio_1<%=i%>" checked="">
                                        <label for="radio_1<%=i%>"><%=subQuestions.get(i - 1).get(0).getText()%></label>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-1"></div>
                                        <input name="<%=q.getId()%>" type="radio" value="<%=subQuestions.get(i - 1).get(1).getId()%>" id="radio_2<%=i%>">
                                        <label for="radio_2<%=i%>"><%=subQuestions.get(i - 1).get(1).getText()%></label>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-1"></div>
                                        <input name="<%=q.getId()%>" type="radio" value="<%=subQuestions.get(i - 1).get(2).getId()%>" id="radio_3<%=i%>">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-1"></div>
                                    <button class="col-sm-1 btn bg-indigo waves-effect btn-lg" type="submit">Submit</>
                                </div>
                            </div>
                        </form>
                    </div>
