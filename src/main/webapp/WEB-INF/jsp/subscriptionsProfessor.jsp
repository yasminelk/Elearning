                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable col-sm-12">
                                        <thead>
                                            <tr>
                                                <th>Student Name</th>
                                                <th>Cours</th>
                                            ...
                                            <%  if (request.getAttribute("subscriptions_list") != null) {
                                                    if (!request.getAttribute("subscriptions_list").equals("")) {
                                                        for (Subscription s : (List<Subscription>) request.getAttribute("subscriptions_list")) {
                                                            out.print("<tr>");
                                                            out.print("<td class='col-sm-4'>" + s.getUser().getFirstName() + " " + s.getUser().getLastName() + "</td>");
                                                            out.print("<td class='col-sm-4'>" + s.getCours().getCoursName() + "</td>");
                                                            out.print("<td class='col-sm-4'>");
                                                            if (!s.isValidated()) {
                                                                out.print("<a href='approvesub?subId="+s.getId()+"' class='btn bg-green waves-effect'><i class='material-icons'>done</i></button>");
                                                            }
                                                            out.print("<a href='removesub?subId="+s.getId()+"' class='btn bg-red waves-effect'><i class='material-icons'>delete_forever</i></button>");
                                                            out.print("</td>");
                                                            out.print("</tr>");
                                                        }
                                                    }
