                        ...
                        <form class="form-horizontal" action="exam" method="POST">
                            ...
                            <div class="body">
                                <div class="form-group">
                                    <label for="cours" class="col-sm-1 control-label">Cours Name</label>
                                    <div class="col-sm-10">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="cours" name="coursName" placeholder="Cours Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
